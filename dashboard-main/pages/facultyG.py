...
data_set1 = [3.8, 2.4, 4.6, 3.2, 2.9, 4.1]
data_set2 = [4.9, 3.3, 2.1, 3.7, 4.5, 2.8]
...
fig3.add_trace(
    go.Scatterpolar(r=data_set1, theta=categories, fill="toself", name="CC")
)

fig3.add_trace(go.Scatterpolar(r=data_set2, theta=categories, fill="toself", name="DAA"))
...
def create_graph(selected_metric="Overall Acceptance"):
    ...
    fig.update_traces(line_color=colors[5], marker_color=colors[5])
    fig.update_layout(
