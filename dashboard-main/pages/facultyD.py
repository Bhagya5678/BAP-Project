...
dash.register_page(__name__, path="/facultyfocus/D", name="Faculty D")
...
data_set1 = [4.4, 3.2, 2.8, 3.9, 4.7, 2.5]
data_set2 = [3.7, 2.9, 4.3, 3.1, 4.1, 2.3]

colors = ["#3d05dd", "#5d22e1", "#7d3ee4", "#9d5be8", "#bc77ec", "#dc94ef", "#fcb0f3"]

# Create radar plot
fig3 = go.Figure()

fig3.add_trace(
    go.Scatterpolar(r=data_set1, theta=categories, fill="toself", name="ML")
)

fig3.add_trace(go.Scatterpolar(r=data_set2, theta=categories, fill="toself", name="DC"))
...
@callback(Output("timeseries-graph-D", "figure"), [Input("metric-dropdown", "value")])
...
layout = html.Div(
    className="mt-4 p-4",
    children=[
        html.H1("Faculty D"),  # heading separate line
        html.Hr(),
        html.Div(
            className="row mt-4",
            children=[
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        html.Div(
                                            className="col-md-12",
                                            children=[
                                                dcc.Graph(id="timeseries-graph-D")
                                            ],
                                        )
                                    ],
                                )
