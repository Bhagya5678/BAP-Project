...
dash.register_page(__name__, path="/facultyfocus/F", name="Faculty F")
...
fig3.add_trace(
    go.Scatterpolar(r=data_set1, theta=categories, fill="toself", name="NLP")
)
...
@callback(Output("timeseries-graph-F", "figure"), [Input("metric-dropdown", "value")])
...
layout = html.Div(
    className="mt-4 p-4",
    children=[
        html.H1("Faculty F"),  # heading separate line
        html.Hr(),
        html.Div(
            className="row mt-4",
            children=[
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        html.Div(
                                            className="col-md-12",
                                            children=[
                                                dcc.Graph(id="timeseries-graph-F")
                                            ],
                                        )
                                    ],
                                )
